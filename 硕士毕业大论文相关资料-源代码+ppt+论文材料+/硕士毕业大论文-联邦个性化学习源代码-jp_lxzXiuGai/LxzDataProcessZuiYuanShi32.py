...
def GeneralStandarizedDataset(data):
...
for i in range(len(X_train_MNIST)):
    X_train_MNIST[i]=GeneralStandarizedDataset(X_train_MNIST[i])
...
for i in range(len(X_train_EMNIST_asml1)):
    X_train_EMNIST_asml1[i]=GeneralStandarizedDataset(X_train_EMNIST_asml1[i])


#私有测试数据集为iccad
X_test_EMNIST_iccad, y_test_EMNIST_iccad=test_data_iccad2012[0].feature_buffer,test_data_iccad2012[0].label_buffer
for i in range(len(X_test_EMNIST_iccad)):
    X_test_EMNIST_iccad[i]=GeneralStandarizedDataset(X_test_EMNIST_iccad[i])


#私有测试数据集为asml1
X_test_EMNIST_asml1, y_test_EMNIST_asml1=test_data_asml1[0].feature_buffer,test_data_asml1[0].label_buffer
for i in range(len(X_test_EMNIST_asml1)):
    X_test_EMNIST_asml1[i]=GeneralStandarizedDataset(X_test_EMNIST_asml1[i])


# 存储公共数据集和iccad训练集
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\X_train_MNIST.npy", arr=X_train_MNIST)
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\y_train_MNIST.npy", arr=y_train_MNIST)

# 存储iccad测试集
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\X_test_EMNIST_iccad.npy", arr=X_test_EMNIST_iccad)
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\y_test_EMNIST_iccad.npy", arr=y_test_EMNIST_iccad)
# 存储asml1训练集
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\X_train_EMNIST_asml1.npy", arr=X_train_EMNIST_asml1)
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\y_train_EMNIST_asml1.npy", arr=y_train_EMNIST_asml1)
# 存储asml1测试集
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\X_test_EMNIST_asml1.npy", arr=X_test_EMNIST_asml1)
np.save(file="D:\SoftwareInstallation\Pycharm(学习资料)\\federated-learning-public-code-master\OriginalHotspotDataset\y_test_EMNIST_asml1.npy", arr=y_test_EMNIST_asml1)
print("wancheng")
