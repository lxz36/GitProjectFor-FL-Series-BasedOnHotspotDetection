...
train_data = train_data[:args.n_asml1] + train_data[5:5+args.n_iccad2012]
train_loader = train_loader[:args.n_asml1] + train_loader[5:5+args.n_iccad2012]
clients_num = args.n_asml1 + args.n_iccad2012
clients_num_per_ds['iccad2012'] = args.n_iccad2012
clients_num_per_ds['asml1'] = args.n_asml1
...
for server_round in range(max_round):
    ...
    for _lr_sch in client_lr_schedulers:
        _lr_sch.step()
    print('\nStart Fed Avg...')
    fed_avg(client_states, server_model)
