...
'''
max_itr_ds = {
    'iccad2012': 80,  #加快训练'iccad2012': 800,
    'asml1': 80}      #加快训练'asml1': 800
weight_decay_ds = {
    'iccad2012': 1e-5,
    'asml1': 1e-5}

max_round = 1  # max training round in server, used to be 50
...
for noiseVariance in noiseVariances:
    ...
    for server_round in range(max_round):
        ...
        for _lr_sch in client_lr_schedulers:
            _lr_sch.step()
        print('\nStart Fed Avg...')
        fed_avgWithNoise(client_states, server_model,[],True,0,noiseVariance)
