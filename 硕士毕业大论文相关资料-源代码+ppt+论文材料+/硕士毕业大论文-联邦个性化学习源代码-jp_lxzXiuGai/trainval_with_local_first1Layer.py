...
for i_number in range(len(numberAsml1)):
    ...
    nowNumberIccad = numberIccad[i_number]
    for i_Ratio in range(len(RatioSum)):
        ...
        arg_parser.add_argument("--n_iccad2012", type=int, default=nowNumberIccad,  #1、初始default=0
        ...
        for server_round in range(max_round):
            ...
            for client_idx in client_selected:  # 对每一个client开启一个对话
                ...
                restore_from_server(client_model, server_model, names_not_restore=[  'conv1_1']) #revise5
                ...
                train(model=client_model,    #revise6
                      ...
                      device=device,
                      untrained_modules=[
                         'conv1_2', 'conv2_1', 'conv2_2', 'fc1','final_fc'])
                # update steps
            ...
            for i, test_data_key in enumerate(test_data_keys):
                for client_idx, client_model in enumerate(client_models):
                    ...
                    if client_model_name in ["model\client_asml1_0","model\client_asml1_1","model\client_asml1_2","model\client_asml1_3","model\client_asml1_4","model\client_asml1_5"] and test_data_key=="asml1":
                        for i_Result in range(len(asml1AccFprTprResult)):
                            asml1AccFprTprResult[i_Result] += outSum[i_Result]/ (clients_num // 2)
                    if client_model_name in ["model\client_iccad2012_0","model\client_iccad2012_1","model\client_iccad2012_2","model\client_iccad2012_3","model\client_iccad2012_4","model\client_iccad2012_5"] and test_data_key=="iccad2012":
