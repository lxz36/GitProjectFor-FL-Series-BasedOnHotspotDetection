...
def cnn_4ConvLayer_2fcLayer_model(n_classes,n1 = 16, n2=16, n3=32,n4=32, nFc1=250,dropout_rate = 0.2,input_shape = (144,32)):#神经网络函数定义；n_classes是分类的类数，iccad节点用了这个模型
    model_A, x = None, None
...
def cnn_4ConvLayer_3fcLayer_model(n_classes, n1=16, n2=16, n3=32, n4=32, nFc1=250,nFc2=250,dropout_rate=0.2,
